  ...
  return (
    <>
      <div className="">
        ...
        <div className="chapter-2-actions absolute bottom-2 w-full flex justify-between items-center h-16 p-4 bg-slate-150">
          ...
          <div className="text-xl text-gray-900">{memoryIdx + 1} / {data.length}</div>

          <button className="px-4 py-2 bg-[#01F9C6] rounded-xl" onClick={handleGuess}>Guess</button>
        </div>
      </div>
